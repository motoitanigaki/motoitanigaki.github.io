...
},{"process":"../../../../../.config/yarn/global/node_modules/process/browser.js"}],"sketch.js":[function(require,module,exports) {
"use strict";
...
var faceapi;
var video;
var detections; // by default all options are set to true
  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return tf.loadLayersModel("https://datamix-internal.s3-ap-northeast-1.amazonaws.com/info-session/material/model/model.json");
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            createCanvas(360, 270); // load up your video

            video = createCapture(VIDEO);
            video.size(width, height); // video.hide(); // Hide the video element, and just show the canvas

            faceapi = ml5.faceApi(video, detection_options, modelReady);
            textAlign(RIGHT);
            _context2.next = 7;
            return tf.loadLayersModel("http://localhost:1234/model/model.json");
...
function gotResults(err, result) {
  ...
  detections = result; // background(220);
...
function drawBox(detections) {
  for (var i = 0; i < detections.length; i++) {
    ...
    var boxHeight = alignedRect._box._height;
    noFill();
    stroke(161, 95, 251);
    strokeWeight(2);
...
function drawLandmarks(detections) {
  ...
  var _loop = function _loop(i) {
    console.log(detections[i].landmarks._positions, detections[i].alignedRect._box);
    var faceFeaturesTmp = [];

    detections[i].landmarks._positions.forEach(function (object) {
      faceFeaturesTmp.push(Object.values(object));
    });

    faceFeaturesTmp.push(Object.values([detections[i].alignedRect._box._height, detections[i].alignedRect._box._width]));
    console.log(faceFeaturesTmp.flat());
    var mouth = detections[i].parts.mouth;
    var nose = detections[i].parts.nose;
    var leftEye = detections[i].parts.leftEye;
    var rightEye = detections[i].parts.rightEye;
    var rightEyeBrow = detections[i].parts.rightEyeBrow;
    var leftEyeBrow = detections[i].parts.leftEyeBrow;
    drawPart(mouth, true);
    drawPart(nose, false);
...
},{"q":"node_modules/q/q.js"}],"../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","sketch.js"], null)
